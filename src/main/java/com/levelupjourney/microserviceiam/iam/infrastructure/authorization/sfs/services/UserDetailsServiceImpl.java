package com.levelupjourney.microserviceiam.iam.infrastructure.authorization.sfs.services;

import com.levelupjourney.microserviceiam.iam.infrastructure.authorization.sfs.model.UserDetailsImpl;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        var user = userRepository.findByEmail_address(username)
